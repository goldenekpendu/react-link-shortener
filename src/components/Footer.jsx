...
const Footer = () => {
    return (
        <div className=" font-inter tracking-tight">
            ...
            <div className=' bg-darkBackground w-full pb-20 pt-10 px-10'>
                <h3 className=' font-bold text-2xl tracking-tight text-center text-background lg:text-4xl'>Try Sniply for free!</h3>
                <p className=' py-5 text-gray-300 max-w-md text-center mx-auto'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>

                <div className=' py-10'>
                    <InputField />
                </div>

                <div className=' flex items-center gap-10 justify-center pt-10'>
